...
const artLd = articleLd({
  headline: (metadata.title as string) || "Debito pubblico di Italia e Spagna",
  lang: "it",
  url: `https://www.cuentas-clara.com/debito-pubblico/`,
  source: [FONTI.bankitalia, FONTI.bde],
  about: "Debito pubblico di Italia e Spagna",
});
