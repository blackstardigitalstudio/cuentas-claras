...
const artLd = articleLd({
  headline: (metadata.title as string) || "Fondi Next Generation EU e PNRR",
  lang: "it",
  url: `https://www.cuentas-clara.com/fondi-europei-pnrr/`,
  source: FONTI.comisionUE,
  about: "Fondi Next Generation EU e PNRR",
});
