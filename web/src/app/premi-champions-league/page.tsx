...
const artLd = articleLd({
  headline: (metadata.title as string) || "Premi della UEFA Champions League",
  lang: "it",
  url: `https://www.cuentas-clara.com/premi-champions-league/`,
  source: FONTI.uefa,
  about: "Premi della UEFA Champions League",
});
