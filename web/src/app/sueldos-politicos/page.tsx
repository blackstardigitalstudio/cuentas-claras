...
const artLd = articleLd({
  headline: (metadata.title as string) || "Retribuciones de los cargos políticos",
  lang: "es",
  url: `https://www.cuentas-clara.com/sueldos-politicos/`,
  source: FONTI.ley31,
  about: "Retribuciones de los cargos políticos",
});
