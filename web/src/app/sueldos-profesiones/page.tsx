...
const artLd = articleLd({
  headline: (metadata.title as string) || "Sueldos de las profesiones públicas",
  lang: "es",
  url: `https://www.cuentas-clara.com/sueldos-profesiones/`,
  source: FONTI.ocse,
  about: "Sueldos de las profesiones públicas",
});
