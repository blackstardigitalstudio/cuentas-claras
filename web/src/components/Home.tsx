      ...
      <section className="mt-8 mb-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            ...
            { href: locale === "it" ? "/spesa-sanita/" : "/gasto-sanidad/", emoji: "🏥", accent: "#34d399", es: "El dinero de la sanidad", it: "I soldi della sanità", subEs: "adónde va, por comunidad", subIt: "dove va, quanto a testa" },
            { href: locale === "it" ? "/spesa-pensioni/" : "/gasto-pensiones/", emoji: "👴", accent: "#fbbf24", es: "El dinero de las pensiones", it: "I soldi delle pensioni", subEs: "la mayor factura pública", subIt: "la spesa più grande" },
            { href: locale === "it" ? "/tasse-stipendio/" : "/impuestos-sueldo/", emoji: "💼", accent: "#f43f5e", es: "¿Cuánto te quitan del sueldo?", it: "Quanto ti tolgono dallo stipendio?", subEs: "IRPF y cotizaciones", subIt: "IRPEF e contributi" },
